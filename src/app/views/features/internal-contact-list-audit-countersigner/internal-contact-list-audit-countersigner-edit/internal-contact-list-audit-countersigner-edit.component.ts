...
@Component({
  selector: 'app-internal-contact-list-audit-countersigner-edit',
  templateUrl: './internal-contact-list-audit-countersigner-edit.component.html',
  styleUrls: ['./internal-contact-list-audit-countersigner-edit.component.scss']
})
export class InternalContactListAuditCountersignerEditComponent implements OnInit {
  ...
  exitItem() {
    ...
    window.location.assign('main/internal-contact-list-audit-countersigner');
  }
