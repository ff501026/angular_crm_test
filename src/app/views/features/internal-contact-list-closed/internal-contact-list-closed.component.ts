...
@Component({
  selector: 'app-internal-contact-list-closed',
  templateUrl: './internal-contact-list-closed.component.html',
  styleUrls: ['./internal-contact-list-closed.component.scss']
})
export class InternalContactListClosedComponent implements OnInit {
...
addItem() {
  ...
  editItem() {
    //this.selectedItem = item;
    // const dialogRef = this.dialog.open(this.editDialog);
    window.location.assign('main/internal-contact-list-closed-edit');
  }
}
