...
@Component({
  selector: 'app-cust-service-work-place-edit',
  templateUrl: './cust-service-work-place-edit.component.html',
  styleUrls: ['./cust-service-work-place-edit.component.scss']
})
export class CustServiceWorkPlaceEditComponent implements OnInit {
